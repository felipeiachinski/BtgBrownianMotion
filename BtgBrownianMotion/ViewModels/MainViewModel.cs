...
namespace BtgBrownianMotion.ViewModels;

public sealed partial class MainViewModel : ObservableObject
{
    [ObservableProperty] private double initialPrice = 100.0;
    [ObservableProperty] private double volatility = 20.0;
    [ObservableProperty] private double meanReturn = 1.0;
    [ObservableProperty] private int days = 252;
    [ObservableProperty] private int simulations = 1;
