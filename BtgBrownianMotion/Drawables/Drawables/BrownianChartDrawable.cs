...
namespace BtgBrownianMotion.Drawables;

public sealed class BrownianChartDrawable : IDrawable
{
    private readonly System.Func<BtgBrownianMotion.ViewModels.ChartSnapshot> _snapshotProvider;
    public BrownianChartDrawable(System.Func<BtgBrownianMotion.ViewModels.ChartSnapshot> snapshotProvider) => _snapshotProvider = snapshotProvider;
